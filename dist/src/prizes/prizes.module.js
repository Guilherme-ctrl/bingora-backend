...
const event_prizes_controller_1 = require("./event-prizes.controller");
...
exports.PrizesModule = PrizesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [event_prizes_controller_1.EventPrizesController, prizes_controller_1.PrizesController],
        providers: [prizes_service_1.PrizesService],
        exports: [prizes_service_1.PrizesService],
    })
], PrizesModule);
