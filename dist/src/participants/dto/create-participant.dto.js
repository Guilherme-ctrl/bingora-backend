...
class CreateParticipantDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { display_name: { required: true, type: () => String, minLength: 1 }, email: { required: false, type: () => String, nullable: true, format: "email" }, phone: { required: false, type: () => String, nullable: true }, notes: { required: false, type: () => String, nullable: true } };
    }
}
...
], CreateParticipantDto.prototype, "display_name", void 0);
__decorate([
